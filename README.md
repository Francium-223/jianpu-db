...
以[th01_02.txt](scores/th01_02.txt)（永遠の巫女）为例，一般的曲谱文件结构应该是这样：
...
~~以[th01_02.json](meta/th01_02.json)为例：~~（正在更新）
